""" Mirror Descent Method from Kimi K1.5 """
import collections
import gc
import os
import shutil
...
class ParallelKimiTrainerForCausalLM(ParallelTrainer):
    def __init__(
            self,
    ...
    def forward(self, rollout_data):
        ...
        loss = (advantages - self.beta * (action_logprobs - old_action_logprobs)) ** 2
...
def train_kimi(
    ...
    trainer = ParallelKimiTrainerForCausalLM(
        policy=policy,
        optimizer=optimizer,
        beta=beta,
