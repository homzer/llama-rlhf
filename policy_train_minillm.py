...
from policy_train_gkd import check_vocab_size, collect_logits_buffer
...
from src.ppo.trainer import ParallelMiniLLMTrainerForCausalLM
...
def train_minillm(
    ...
    trainer = ParallelMiniLLMTrainerForCausalLM(
        policy=policy,
        optimizer=optimizer,
...
def run(
    ...
    for epoch, datalist in IterationHandler(json_load(train_file), epochs, chunk_size, begin_epoch):
        ...
        logits_rollout_buffer["old_action_logprobs"] = policy_rollout_buffer["action_logprobs"]
